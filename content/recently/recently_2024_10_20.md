...
This year was an improvement over last and, with feedback in hand, I hope to take next year another step forward. Conversation topics were to be expected: DRM is fundamentally broken{{< sidenote >}}David "retr0id" Buchanan, "MPEG-CENC: Defective by Specification," _Phrack_ 71 (2024), <https://phrack.org/issues/71/6.html#article>.{{< /sidenote >}}, legacy devices are no good, interstitials are extremely good, and [we should stop implementing the same thing repeatedly.](https://github.com/streaming-video-technology-alliance/common-media-library/)

{{< figure src="/img/recently/2024-10-20/foms2024.webp" caption="FOMS '24 @ Crunchyroll HQ" >}}
...
{{< figure src="/img/recently/2024-10-20/demuxed2024.webp" caption="Demuxed '24 @ Regency Ballroom" >}}
...
Lets just say my media diet these last few weeks has been non-existent. I look forward to starting Metaphor: ReFantazio, I have a backlog of Antonioni films to work through, and I need to punch through the end of The Poetics of Space.{{< sidenote >}}Gaston Bachelard, _The Poetics of Space_, trans. Maria Jolas (New York: Orion Press, 1964), <https://www.goodreads.com/book/show/13269.The_Poetics_of_Space>.{{< /sidenote >}}
